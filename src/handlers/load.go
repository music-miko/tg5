...
func LoadModules(c *gotdbot.Client) {
	...
	c.OnUpdateNewCallbackQuery(setupGuideCallback, callbackquery.Prefix("setup_guide"))
	c.OnUpdateNewCallbackQuery(startBackCallback, callbackquery.Prefix("start_back"))
